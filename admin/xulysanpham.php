			...
			<div class="col-md-8">
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><a href="index.php?act=xulysanpham&xoa=<?php echo $row_sp['sanpham_id'] ?>">Xóa</a> || <a href="index.php?act=xulysanpham&quanly=capnhat&capnhat_id=<?php echo $row_sp['sanpham_id'] ?>">Cập nhật</a></td>
					</tr>
				<?php
					} 
					?> 
